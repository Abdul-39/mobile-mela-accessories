    ...
    <main class="page-enter">
      @if (loading()) {
        ...
        <div class="container" style="padding: 3rem 0;">
          <div
            class="skeleton"
            style="height: 480px; border-radius: var(--radius-lg);"
          ></div>
        </div>
...
export class ProductDetailsComponent implements OnInit {
      ...
      this.productService.getProductBySlug(slug).subscribe({
        ...
        next: p => {
          ...
          if (p) {
            ...
            // Safely handle products without images
            ...
            // Safely handle products without colors
  ...
  onQtyInput(event: Event): void {
    ...
    } else if (val > p.stockQuantity) {

      this.quantity.set(p.stockQuantity);

    } else {

      this.quantity.set(Math.floor(val));
